...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\LENOVO\OneDrive\Desktop\Tubes_KEL2\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\LENOVO\\OneDrive\\Desktop\\Tubes_KEL2\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','homebph',
'daftarevent','daftarevent.store','riwayatevent','akun','akun.updatePassword',
'logout','tambahEventBph','lihatEvent','tambahEvent.store','adminhome',
'kelolauser','adduser','adduser.store','kelolauser.edit','kelolauser.update',
'kelolauser.destroy','dataevent','addevent','addevent.store','dataevent.edit',
'dataevent.update','dataevent.destroy','dataukm','addukm','addukm.store',
'dataukm.edit','dataukm.update','dataukm.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.addevent','admin.addukm','admin.adduser','admin.adminhome','admin.dataevent',
'admin.dataukm','admin.editevent','admin.editukm','admin.edituser','admin.kelolauser',
'bph.homebph','bph.lihatEvent','bph.tambahEventBph','login','partials.adminNav',
'partials.bphNav','partials.bphfoot','partials.nav','userNormal.akun','userNormal.daftarevent',
'userNormal.detailevent','userNormal.home','userNormal.riwayatevent','welcome','laravel-exceptions-renderer::components.card',
